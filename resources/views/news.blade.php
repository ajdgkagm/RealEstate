...
<head>
    ...
    <style>
        ...
        .metro-tile .glyphicon, .metro-tile .badge {
            padding: 0 25px;
            float: left;
        }

        .metro-tile-sm .glyphicon, .metro-tile-sm .label, .metro-tile-sm .badge {
            font-size: 20pt;
        }

        .metro-tile-md .glyphicon, .metro-tile-md .label, .metro-tile-md .badge {
            font-size: 40pt;
        }

        .metro-tile-lg .glyphicon, .metro-tile-lg .label, .metro-tile-lg .badge {
            font-size: 80pt;
        }
        ...
        .metro-tile-page.active {
            display: block;
        }

        .metro-tile-page.active h4 {
            z-index: 100;
            position: absolute;
            color: white;
            bottom: 10%;
        ...
        .metro-tile-md .metro-tile-page.active h4, .metro-tile-lg .metro-tile-page.active h4 {
            font-size: 22px;
            bottom: 10%;
        }

        .metro-tile-sm .metro-tile-page.active h4 {
            font-size: 12px;
            bottom: 5%;
            text-align: right;
        }

        .metro-tile-page.active img {
            position: absolute;
            left: 0;
            top: 0;
        }

        .metro-tile-page-success {
            color: #fff;
            background-color: #5cb85c;
            border-color: #4cae4c;
        }

        .metro-tile-page-success .badge {
            color: #4cae4c;
            background-color: #fff;
        }

        .metro-tile-page-danger {
            color: #fff;
            background-color: #d9534f;
            border-color: #d43f3a;
        }

        .metro-tile-page-danger .badge {
            color: #d9534f;
            background-color: #fff;
        }

        .metro-tile-page-warning {
            color: #fff;
            background-color: #f0ad4e;
            border-color: #eea236;
        }

        .metro-tile-page-warning .badge {
            color: #eea236;
            background-color: #fff;
        }

        .metro-tile-page-info {
            color: #fff;
            background-color: #5bc0de;
            border-color: #46b8da;
        }

        .metro-tile-page-info .badge {
            color: #46b8da;
            background-color: #fff;
        }

        .metro-tile-page-primary {
            color: #fff;
            background-color: #428bca;
            border-color: #357ebd;
        }

        .metro-tile-page-primary .badge {
            color: #357ebd;
            background-color: #fff;
        }
            ...
            <div class="col-md-12">
                <div class="metro-tile-container">
                    <div class="metro-tile metro-tile-lg">
                        <div class="metro-tile-page active metro-tile-page-warning">
                            <img src="resort3.jpg">
                        </div>
                        <div class="metro-tile-page metro-tile-page-info">
                            <p>
                    ...
                    <div class="metro-tile metro-tile-md">
                        <div class="metro-tile-page active metro-tile-page-info">
                            <img src="resort.jpg" alt="MetroTiles"/>
                        </div>
                        <div class="metro-tile-page metro-tile-page-primary">
                            <p>Supports Images in single pages</p>
                        </div>
                    </div>
                    <div class="metro-tile metro-tile-md">
                        <div class="metro-tile-page active metro-tile-page-primary">
                            <img src="resort2.jpg" alt="MetroTiles"/>
                        </div>
                        <div class="metro-tile-page metro-tile-page-primary">
                            <h4> also supports images in multiple pages</h4>
                            <img src="http://www.blogcdn.com/de.engadget.com/media/2012/02/windows-new-logo-thumb-550xauto-84054.jpg"
                                 alt="MetroTiles"/>
                        </div>
                    </div>
                    <div class="metro-tile metro-tile-lg">
                        ...
                        <div class="metro-tile-page metro-tile-page-success">
                            <p>Different sizes.</p>
                            <p>Small Tiles are not 100% finished.</p>
                        </div>
                    </div>
                    <div class="metro-tile metro-tile-md">
                        <div class="metro-tile-page active metro-tile-page-primary">
                    ...
                    <div class="metro-tile metro-tile-lg">
                        <div class="metro-tile-page active metro-tile-page-primary">
                            ...
                            <h4>Glyphicon and Badge support</h4>
                        </div>
                        <div class="metro-tile-page metro-tile-page-primary">

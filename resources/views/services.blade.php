...
<div class="container">
    <div class="row">
        <div class="col-md-12">
         <h1 class="lg-text">COMPANY PROFILE</h1><br>
				...
				<div class="col-md-8">
					<div class="row">
						<div class="col-md-12 services-inner">
							<span><i class="sl-icon-user-following"></i></span>
							<div class="desc">
								<h3>CUSTOMER FOCUS</h3>
<p>Delivery beyond customer satisfaction</p>					
					</div>
							</div>
						<div class="col-md-12 services-inner">
							<span><i class="sl-icon-trophy"></i></span>
							<div class="desc">
								<h3>EXCELLENCE</h3>
						<p>Ensuring extra ordinary performance</p>
						</div>
							</div>
							<div class="col-md-12 services-inner">
							<span><i class="sl-icon-bulb"></i></span>
							<div class="desc">
								<h3>INNOVATION</h3>
						<p>Bringing new ideas to life</p>	</div>
							</div>
							<div class="col-md-12 services-inner">
							<span><i class="sl-icon-share"></i></span>
							<div class="desc">
								<h3>SOCIAL RESPONSIBILITY</h3>
							<p>Concern for people by improving quality of living</p></div>
							</div>
							<div class="col-md-12 services-inner">
							<span><i class="sl-icon-note"></i></span>
							<div class="desc">
								<h3>INTEGRITY</h3>
							<p>Doing the right thing</p></div>
						</div>
						...
						<div class="col-md-12 services-inner">
							<span><i class="sl-icon-people"></i></span>
							<div class="desc">
								<h3>LEADERSHIP</h3>
								<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
							</div>
